    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-lg mb-10">
          <span className="inline-block font-mono text-sm tracking-wider text-neon-yellow mb-2">FEATURED MODEL</span>
        ...
        <div className="grid md:grid-cols-5 gap-8 items-center">
          ...
          <div className="md:col-span-2 relative">
            <div className="vintage-box p-0 overflow-hidden">
              <img 
                src="/lovable-uploads/17648424-54a8-44bd-8420-fdae12db70cc.png"
                alt="BYD Sealion 7" 
                className="w-full h-auto sepia-filter transition-all duration-700 hover:brightness-110 hover:sepia-0"
              />
          ...
          <div className="md:col-span-3 grid md:grid-cols-3 gap-4">
            {pricingTiers.map((tier, index) => (
              <div 
                ...
                style={{
                  transform: hoveredTier === index ? 'translateY(-10px)' : 'none',
              ...
              >
                ...
                <div className="p-5 bg-card rounded-b-md border border-t-0 border-border transition-all duration-300">
                  ...
                  <button className={`w-full py-2 px-4 rounded font-mono text-sm tracking-wider transition-colors duration-300 ${index === 0 ? 'bg-neon-pink text-white hover:bg-neon-pink/90' : index === 1 ? 'bg-neon-blue text-white hover:bg-neon-blue/90' : 'bg-neon-purple text-white hover:bg-neon-purple/90'}`}>
                    SELECT PLAN
                  </button>
                </div>
              </div>
